...
#Sobre o projeto
<i>🟤Objetivo Hard Skill: Criar uma pagina de um produto para uma empresa ficticia usando as ferramentas pedidas: Bootstrap, javascript, css, html, API</i>
<i>🟣Objetivo Soft Skill:Criar PITCH e uma apresentar o produto</i>
